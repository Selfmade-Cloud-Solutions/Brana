...
// Animation
const Duration branaButtonAnimationDuration = Duration(milliseconds: 600);
const Duration branaCardAnimationDuration = Duration(milliseconds: 400);
